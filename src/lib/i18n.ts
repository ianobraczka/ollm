...
export const ASSESSMENT_TEXT = {
  en: {
    ...
    courseChatPrivacyAlert:
      "Student data is protected. The names are replaced with aliases before being sent to the model. Real names are restored only in this chat view.",
  ...
  "pt-BR": {
    ...
    courseChatPrivacyAlert:
      "Os dados dos alunos são protegidos. Os nomes são trocados por aliases antes de serem enviados ao modelo. Os nomes reais são restaurados apenas nesta conversa.",
